...
class Wow : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //ToggleTheme:
        val layout = findViewById<ScrollView>(R.id.wowPage);
        ...
        val layoutSplash = findViewById<ScrollView>(R.id.wowPage);
        val fade = AnimationUtils.loadAnimation(this,R.anim.fade_in)
        layoutSplash.startAnimation(fade)
        Toast.makeText(this, "Wow Section", Toast.LENGTH_SHORT).show()
