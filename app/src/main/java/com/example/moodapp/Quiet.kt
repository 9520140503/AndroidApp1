...
class Quiet : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_quiet)

        val layout = findViewById<ScrollView>(R.id.quietPage);
        ...
        val layoutSplash = findViewById<ScrollView>(R.id.quietPage);
        val fade = AnimationUtils.loadAnimation(this,R.anim.fade_in)
        layoutSplash.startAnimation(fade)
        Toast.makeText(this, "Quiet Section", Toast.LENGTH_SHORT).show()
