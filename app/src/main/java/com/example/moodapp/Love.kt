...
class Love : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val layout = findViewById<ScrollView>(R.id.lovePage) // your layout ID
        ...
        val layoutSplash = findViewById<ScrollView>(R.id.lovePage);
        val fade = AnimationUtils.loadAnimation(this,R.anim.fade_in)
        layoutSplash.startAnimation(fade)
        Toast.makeText(this, "Love Section", Toast.LENGTH_SHORT).show()
        ...
        watch.setOnClickListener{
            val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://www.youtube.com/watch?v=euCqAq6BRa4"))
